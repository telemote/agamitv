...
class RecentCVC: UIViewController, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        let frame = CGRectMake(self.view.frame.origin.x, self.view.frame.origin.y+48, self.view.frame.size.width, (self.view.frame.size.height - self.tabBarController!.tabBar.frame.size.height-boxsize*3/7));
